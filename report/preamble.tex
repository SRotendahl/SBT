...
\usepackage{fancyhdr}
\pagestyle{fancy}
\rhead{A. Nicolaisen \& A. Scheurer \& S. Rotendahl}
\usepackage{datetime}
\usepackage{moresize}
...
\newcommand{\coverpage}[1]{%
	\pagenumbering{roman}%
	\thispagestyle{empty}%
	\lhead{\textsc{Subjects in Blockchain Technology}}%
    \title{PFP}%
    \author{Andreas Nicolaisen \& Alexander Scheurer \& Simon Rotendahl}%
	...
	\rulebreak%
    {\Large\textbf{Subjects in Blockchain Technology}}
...
\input{includes/solidity-highlighting.tex}
